    ...
    let answers = await inquirer.prompt([
        {
            type: "list",
            name: "role",
            message: "Which role would you like to remove? You cannot remove a role that is still being used.",
            choices: roles
        }
    ]);
    return answers;
    ...
    let answers = await inquirer.prompt([
        {
            type: "list",
            name: "department",
            message: "Which department would you like to remove? You cannod remove a department that is still being used.",
            choices: departments
        }
    ]);
    return answers;
